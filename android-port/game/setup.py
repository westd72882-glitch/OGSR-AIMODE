...
extensions = [
    ...
    Extension(name='mc.net.minecraft.game.entity.EntityLiving',
              ...
              include_dirs=[numpy.get_include()], **flags),
    Extension(name='mc.net.minecraft.game.entity.EntityCreature',
              sources=['mc/net/minecraft/game/entity/EntityCreature.pyx'],
              include_dirs=[numpy.get_include()], **flags),
    ...
    Extension(name='mc.net.minecraft.client.render.camera.Frustum',
              sources=['mc/net/minecraft/client/render/camera/Frustum.pyx'],
              include_dirs=[numpy.get_include()], **flags),
    ...
    Extension(name='mc.net.minecraft.game.level.World',
              ...
              include_dirs=[numpy.get_include()], **flags),
    Extension(name='mc.net.minecraft.game.level.Light',
              sources=['mc/net/minecraft/game/level/Light.pyx'],
              include_dirs=[numpy.get_include()], **flags),
    ...
    Extension(name='mc.net.minecraft.game.level.block.BlockFire',
              ...
              include_dirs=[numpy.get_include()], **flags),
    Extension(name='mc.net.minecraft.game.level.path.Pathfinder',
              sources=['mc/net/minecraft/game/level/path/Pathfinder.pyx'],
              include_dirs=[numpy.get_include()], **flags),
    Extension(name='mc.net.minecraft.game.level.path.PathPoint',
              sources=['mc/net/minecraft/game/level/path/PathPoint.pyx'],
              include_dirs=[numpy.get_include()], **flags),
    Extension(name='mc.net.minecraft.game.level.path.Path',
              sources=['mc/net/minecraft/game/level/path/Path.pyx'],
              include_dirs=[numpy.get_include()], **flags),
]
