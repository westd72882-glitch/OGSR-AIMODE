...
cdef class Frustum:
    ...
    cdef bint isBoundingBoxInFrustum(self, float x0, float y0, float z0,
        ...
        for i in range(6):
            if self.__frustum[i][self._a] * x0 + self.__frustum[i][self._b] * y0 + \
               self.__frustum[i][self._c] * z0 + self.__frustum[i][self._d] <= 0.0 and \
               self.__frustum[i][self._a] * x1 + self.__frustum[i][self._b] * y0 + \
               self.__frustum[i][self._c] * z0 + self.__frustum[i][self._d] <= 0.0 and \
               self.__frustum[i][self._a] * x0 + self.__frustum[i][self._b] * y1 + \
               self.__frustum[i][self._c] * z0 + self.__frustum[i][self._d] <= 0.0 and \
               self.__frustum[i][self._a] * x1 + self.__frustum[i][self._b] * y1 + \
               self.__frustum[i][self._c] * z0 + self.__frustum[i][self._d] <= 0.0 and \
               self.__frustum[i][self._a] * x0 + self.__frustum[i][self._b] * y0 + \
               self.__frustum[i][self._c] * z1 + self.__frustum[i][self._d] <= 0.0 and \
               self.__frustum[i][self._a] * x1 + self.__frustum[i][self._b] * y0 + \
               self.__frustum[i][self._c] * z1 + self.__frustum[i][self._d] <= 0.0 and \
               self.__frustum[i][self._a] * x0 + self.__frustum[i][self._b] * y1 + \
               self.__frustum[i][self._c] * z1 + self.__frustum[i][self._d] <= 0.0 and \
               self.__frustum[i][self._a] * x1 + self.__frustum[i][self._b] * y1 + \
               self.__frustum[i][self._c] * z1 + self.__frustum[i][self._d] <= 0.0:
                return False
